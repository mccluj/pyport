...
# Mock Portfolio and MarketData for testing
@pytest.fixture
...
# Tests for RebalancingRules.determine_actions
def test_determine_actions_no_action_needed(mock_portfolio, mock_market_data):
    rules = {
        'index_exposure': {'target_min': 0.5, 'target_max': 0.7},
        'portfolio_duration': {'target_min': 3, 'target_max': 7},
    }
    rebalancing_rules = RebalancingRules(rules)
...
def test_determine_actions_buy_index_futures(mock_portfolio, mock_market_data):
    rules = {
        'index_exposure': {'target_min': 0.5, 'target_max': 0.7},
        'portfolio_duration': {'target_min': 3, 'target_max': 7},
    }
...
def test_determine_actions_sell_index_futures(mock_portfolio, mock_market_data):
    rules = {
        'index_exposure': {'target_min': 0.5, 'target_max': 0.7},
        'portfolio_duration': {'target_min': 3, 'target_max': 7},
    }
...
# ... additional tests for other scenarios and methods
